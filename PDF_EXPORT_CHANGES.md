...
- Chromium renders the HTML and uses its HarfBuzz text shaping engine for Myanmar.
...
The Puppeteer implementation was then tested with the real application flow and confirmed working.
